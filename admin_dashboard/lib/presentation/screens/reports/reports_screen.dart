...
class ReportsScreen extends StatelessWidget {
  ...
  static final _reports = [
    {
      'type': 'Content',
      'description': 'Inappropriate answer in Q&A section',
      'reporter': 'student22',
      'status': 'Open',
      'date': '31 Jul 2026'
    },
    {
      'type': 'Misconduct',
      'description': 'User suspected of sharing exam answers live',
      'reporter': 'student08',
      'status': 'Open',
      'date': '30 Jul 2026'
    },
    {
      'type': 'Content',
      'description': 'Offensive comment in 300L discussion',
      'reporter': 'student15',
      'status': 'Resolved',
      'date': '29 Jul 2026'
    },
    {
      'type': 'Impersonation',
      'description': 'Account using another student\'s matric no.',
      'reporter': 'student31',
      'status': 'Open',
      'date': '28 Jul 2026'
    },
        ...
        child: Row(
          children: [
            ...
            if (isOpen) ...[
              ...
              const Text('Resolved',
                  style: TextStyle(
                      color: AdminColors.success, fontWeight: FontWeight.w600)),
          ],
        ),
      ),
    );
