...
class _GpaCalculatorScreenState extends ConsumerState<GpaCalculatorScreen>
  ...
  Future<void> _save() async {
    ...
    final courses = _entries
        .map((e) => GpaCourseModel(
              name: e.nameCtrl.text.trim().isEmpty
                  ? 'Course'
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          ElevatedButton(
              onPressed: _calculate, child: const Text('Calculate GPA')),
      ...
      child: Column(
        ...
        children: [
            ...
            data: (cgpa) {
              ...
              return Container(
                ...
                child: Column(children: [
                  ...
                  const SizedBox(height: 10),
                  Text(
                      '${cgpa.semesters} semester(s) • ${cgpa.totalUnits} total units',
                      style:
                          const TextStyle(color: Colors.white70, fontSize: 13)),
                ]),
              );
          ...
          semestersAsync.when(
            loading: () => const Center(child: CircularProgressIndicator()),
            error: (_, __) =>
                const Center(child: Text('Could not load saved GPA.')),
            data: (semesters) {
              ...
              return Column(
                ...
                children: [
                  ...
                  ...semesters.map((s) => _SemesterCard(
                        ...
                        onDelete: () async {
                          final ok = await ref
                              .read(gpaActionsProvider.notifier)
                              .deleteSemester(s.id);
                          if (mounted && ok) {
