...
export class AiController {
  ...
  explain(@Body('concept') concept: string, @Body('courseContext') courseContext?: string) {
  ...
  @Post('predict-topics')
  @ApiOperation({ summary: 'Predict likely exam topics based on course content' })
  predictTopics(@Body('courseTitle') courseTitle: string, @Body('recentTopics') recentTopics: string[]) {
